...
model.evaluation.plot(sc.obj) # Average AUC: 0.799
sc.obj
...
summary(colSums(predict_oGZ)/nrow(predict_oGZ)) # mean 0.8860, median 0.8840
...
summary(colSums(predict_yGZ)/nrow(predict_yGZ)) # mean 0.8952, median 0.8922
